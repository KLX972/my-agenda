<template lang="html">
  <div class="detail-event">
    ...
    <div class="edit-button-content" @click="editEvent()">
...
export default {
  ...
  methods:{
    ...
    editEvent(){
      ...
      this.updateEvents(this.chosenEvent)
      this.shutDownModal()
    },
    shutDownModal(){
  ...
  mounted(){
    ...
    let startDate = this.chosenEvent.startDate
    ...
    this.startDateValue = startHours + ':' + startMinutes

    let endDate = this.chosenEvent.endDate
    ...
    this.endDateValue  = endHours + ':' + endMinutes
  }
}
</script>
